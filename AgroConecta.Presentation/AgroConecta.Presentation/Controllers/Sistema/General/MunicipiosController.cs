...
public class MunicipiosController : InitialController<MunicipioDTO, Municipio>
{
    public MunicipiosController(IMunicipioService service, ILogService logger, IActionContextAccessor actionContextAccessor)
