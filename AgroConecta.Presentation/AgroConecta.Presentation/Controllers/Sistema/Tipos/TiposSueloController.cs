...
public class TiposSueloController : InitialController<TipoSueloDTO, TipoSuelo>
{
    public TiposSueloController(ITipoSueloService service, ILogService logger, IActionContextAccessor actionContextAccessor)
