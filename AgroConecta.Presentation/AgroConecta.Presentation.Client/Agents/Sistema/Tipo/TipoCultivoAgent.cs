...
public class TipoCultivoAgent : InitialAgent<TipoCultivoDTO>, ITipoCultivoAgent
{
    public TipoCultivoAgent(HttpClient httpClient, IJSRuntime jsRuntime) 
        : base(httpClient, "api/TiposCultivo", jsRuntime) // Ruta del controlador
    {
    }
